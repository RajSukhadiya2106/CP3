                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info pt-0">
                            ...
                            <ul>
                                <li><i class="fa fa-fax"></i> Shop No.2,High School Shopping Centre,Chikhli,Gujarat</li>
                                <li><i class="fa fa-phone"></i>rajsukhadiya5322@gmail.com</li>
                                <li><i class="fa fa-envelope-o"></i> +919426111125</li>
                            </ul>
