                        ...
                        <div class="widget-item mt-40">
                            ...
                            <div class="widget-body">
                                <ul class="location-wrap">
                                    ...
                                    <li><i class="ion-ios-telephone-outline"></i>Phone: <a href="%2b0025425456554">+919426111125</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 order-2 order-md-1">
                        <div class="copyright-text text-center text-md-left">
                            <p>Copyright 2023 <a href="index.php">Jaymin Footwear</a>. All Rights Reserved</p>
                        </div>
                    </div>
