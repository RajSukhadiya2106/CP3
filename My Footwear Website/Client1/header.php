...
if (isset($_SESSION['User_id'])) {
    ...
    // Now you can safely use $uid as the User_id.
} else {
    // Handle the case where 'User_id' is not set in the session (e.g., redirect to a login page or display an error message).
}
