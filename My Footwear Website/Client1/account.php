                                                ...
                                                <div>
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="single-input-item">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $row['Area_id']; ?>" <?php if ($row['Area_name'] == $id) {
                                                                                                                    echo 'selected';
                                                                                                                } ?>>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (
        isset($_POST["User_name"]) && isset($_POST["Email"]) && isset($_POST["Address"]) && isset($_POST["Contact_no"]) && isset($_POST["Password"])
        && isset($_POST["Area_id"])
    ) {
