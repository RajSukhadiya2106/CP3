            ...
            <div class="row">
                <div class="col-12">
                    <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
                        ...
                        <div class="hero-single-slide">
                            <div class="hero-slider-item bg-img" data-bg="assets/img/banner/banner-2.jpg">
                                <div class="hero-slider-content slide-1">
                                    ...
                                    <p class="slide-desc">Wide range of Shoes. Choose from heels, loafers, floaters,
                                        sports shoes & more. Buy now! Best Deals. </p>
                        ...
                        <!-- single slider item start -->
                        <div class="hero-single-slide">
                            <div class="hero-slider-item bg-img" data-bg="assets/img/banner/b2.jpg">
                                <div class="hero-slider-content slide-1">
                                    <h5 class="slide-subtitle">Trending!</h5>
                                    <h2 class="slide-title">Collection</h2>
                                    <p class="slide-desc">Wide range of Shoes. Choose from heels, loafers, floaters,
                                        sports shoes & more. Buy now! Best Deals. </p>
                                    <a href="shop.html" class="btn btn-hero">SHOP NOW</a>
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        ...
                        <p class="sub-title">Our Products We are manufacturer and supplier best series of Casual Shoes,
                            Womens SportsShoes, Canvas Shoes, Mens Ankle Boots and Mens Sandals.</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        ...
                        <p class="sub-title">Wide range of Shoes for Men. Choose from loafers, floaters, sports shoes &
                            more.</p>
                    </div>
                </div>
            </div>
