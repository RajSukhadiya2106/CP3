...
<?php 
$oid=$_GET['id'];
$sql="select * from `order` o join `order details` ot join product p where o.Order_id=ot.Order_id and ot.P_id=p.P_id and O.Order_id='".$oid."'"	;
            ...
            <div class="minicart-inner-content">
                ...
                <div class="minicart-content-box">
                    ...
                    <div class="minicart-button">
                        ...
                        <a href="cart1.php"><i class="fa fa-share"></i> checkout</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from demo.hasthemes.com/juan-preview-v1/juan/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2019 08:05:55 GMT -->
</html>