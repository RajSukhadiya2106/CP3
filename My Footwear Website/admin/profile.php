...
<div class="main-content">
                ...
                <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                  <div class="row">
                    <div class="col-md-3 col-6 b-r">
                      ...
                      <br>
                      <p class="text-muted">Jaymin Footwear</p>
                    </div>
                    <div class="col-md-3 col-6 b-r">
                      <strong>Mobile</strong>
                      <br>
                      <p class="text-muted">+919426111125</p>
                    </div>
                    <div class="col-md-3 col-6 b-r">
                      <strong>Email</strong>
                      <br>
                      <p class="text-muted">rajsukhadiya5322@gmail.com</p>
                    </div>
                    <div class="col-md-3 col-6">
                      <strong>Location</strong>
                      <br>
                      <p class="text-muted">Gujarat</p>
                    </div>
                  </div>
                  <p class="m-t-30">
                    Jaymin Footwear is an online and user friendly web application for online shoes shopping. Using the
                    web application,
                    customers can buy different type of shoes online.
                    Our website provides stylish, comfortable and casual footwear for different category wise like
                    man’s, woman’s and kid’s
                  </p>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="form-control" name="Area_id"
                                          ...
                                          while ($row2 = mysqli_fetch_array($result2)) {
                                            ?>
                                            <option value="<?php echo $row2['Area_id']; ?>" <?php if ($row2['Area_name'] == $id) {
                                                 echo 'selected';
                                               } ?>>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (
      isset($_POST["User_name"]) && isset($_POST["User_img"]) && isset($_POST["Email"]) && isset($_POST["Address"]) && isset($_POST["Contact_no"]) && isset($_POST["Password"])
      && isset($_POST["Area_id"])
    ) {
